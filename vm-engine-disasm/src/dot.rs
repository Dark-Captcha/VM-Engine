...
use vm_engine_core::graph::block::EdgeKind;
use vm_engine_core::graph::callgraph::CallGraph;
use vm_engine_core::graph::Cfg;
...
fn dot_node_id(block_id: vm_engine_core::ir::BlockId) -> String {
    format!("B{}", block_id.0)
}

fn dot_func_id(func_id: vm_engine_core::ir::FuncId) -> String {
    format!("F{}", func_id.0)
}
