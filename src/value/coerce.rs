...
pub fn to_number(val: &Value) -> f64 {
    match val {
        ...
        Value::Object(_) | Value::Array(_) | Value::Bytes(_) | Value::Closure(_) => f64::NAN,
    }
}
...
pub fn to_string(val: &Value) -> String {
    match val {
        ...
        Value::Array(_) => "[object Array]".into(),
        Value::Bytes(_) => "[object Bytes]".into(),
        Value::Closure(_) => "[object Function]".into(),
    }
}
